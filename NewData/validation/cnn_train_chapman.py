...
from preprocessing.chapman_preprocessing import load_external_validation, per_lead_global_normalization
from utils.utils_main import plot_all_metrics, print_clean_report
...
def run_experiment(config):
    ...
    wandb_logger = WandbLogger(project="CNN_Chapman_Train", entity="martintoseski13-kaunas-university-of-technology", name=version, log_model=True)

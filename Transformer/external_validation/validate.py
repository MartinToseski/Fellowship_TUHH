...
device = "cuda"
checkpoint = Path("../CNN/logs/ArchAblation_GridSearch/d384_head8_lay6_ff2304_ptch4_plmean_poslearnable_dr0.1_lr0.0005_ep100_optadamw_pat15_patt0.0001_wd0.01_lossweighted_bce_actgelu_normpre_20260713_052757/checkpoints/epoch=57-val_f1_macro=0.7221-val_auc_macro=0.9125.ckpt")
...
results = evaluate(probs, labels, thresholds=[0.68, 0.53, 0.395, 0.605, 0.605], class_names=SUPERCLASSES)
